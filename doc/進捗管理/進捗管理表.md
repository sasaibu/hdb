...
| **UI部品** |  |  |  |  |  |  |
| react-native-vector-icons | ^10.0.3 | 未インストール | ❌ 未実装 | 中 | 2025-08-15 | アイコン表示 |
| react-native-chart-kit | ^6.12.0 | 未インストール | ❌ 未実装 | 中 | 2025-08-15 | グラフ表示 |
...
- **@react-native-firebase/remote-config** - 動的設定
