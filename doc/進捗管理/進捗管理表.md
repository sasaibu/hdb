...
| **🟡 高優先度修正作業** | **Healthデータ登録API修正** | TBD | 2025-07-23 | 2025-07-24 | 未着手 | 0% | 1.5 | 血圧データ拡張 | API仕様変更 | 中 | mockApi.ts uploadVitalsBatch() - 測定項目コード変換、value1/value2/value3構造、日中データ対応、削除フラグ対応 |
