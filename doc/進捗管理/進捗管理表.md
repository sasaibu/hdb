...
|----------|----------------|----------------|----------------|------------|------------|-----------|------|
| **画面コンポーネント** |  |  |  |  |  |  |  |
| ログイン | LoginScreen.tsx | LoginScreen.test.tsx | 作成済 | 2025-07-15 | ❌ モック問題 | - | RefreshControlモック問題 |
| ホーム | HomeScreen.tsx | HomeScreen.test.tsx | 作成済 | 2025-07-15 | ❌ モック問題 | - | RefreshControlモック問題 |
| スプラッシュ | SplashScreen.tsx | SplashScreen.test.tsx | 作成済 | 2025-07-15 | ❌ モック問題 | - | RefreshControlモック問題 |
| バイタルデータ | VitalDataScreen.tsx | VitalDataScreen.test.tsx | 作成済 | 2025-07-15 | ❌ モック問題 | - | RefreshControlモック問題 |
| マイページ | MyPageScreen.tsx | MyPageScreen.test.tsx | 作成済 | 2025-07-15 | ❌ モック問題 | - | RefreshControlモック問題 |
| WebView | WebViewScreen.tsx | WebViewScreen.test.tsx | 作成済 | 2025-07-15 | ❌ WebViewモック問題 | - | WebViewモック設定エラー |
| 通知設定 | NotificationSettingsScreen.tsx | NotificationSettingsScreen.test.tsx | 作成済 | 2025-07-15 | ❌ モック問題 | - | RefreshControlモック問題 |
| 通知履歴 | NotificationHistoryScreen.tsx | NotificationHistoryScreen.test.tsx | 作成済 | 2025-07-15 | ❌ モック問題 | - | RefreshControlモック問題 |
...
| データ移行ログイン | DataMigrationLoginScreen.tsx | DataMigrationLoginScreen.test.tsx | 作成済 | 2025-07-15 | ❌ モック問題 | - | RefreshControlモック問題 |
| 連携サービス設定 | LinkedServicesSettingsScreen.tsx | LinkedServicesSettingsScreen.test.tsx | 作成済 | 2025-07-15 | ❌ モック問題 | - | RefreshControlモック問題 |
| DBテスト | DatabaseTestScreen.tsx | DatabaseTestScreen.test.tsx | 作成済 | 2025-07-15 | ❌ モック問題 | - | RefreshControlモック問題 |
| **UIコンポーネント** |  |  |  |  |  |  |  |
...
| 通知 | NotificationService.ts | NotificationService.test.ts | 作成済 | 2025-07-15 | ❌ Firebase依存 | - | @react-native-firebase/messaging未インストール |
...
| **フック・ユーティリティ** |  |  |  |  |  |  |  |
| 認証フック | useAuth.ts | useAuth.test.ts | 作成済 | 2025-07-15 | ✅ 成功 | - | 認証状態管理テスト成功 |
...
### テスト実施サマリー（2025年7月15日 14:38実行）

| 項目 | 数 | 割合 | 前回比較 |
|------|-----|------|----------|
| **総テストスイート数** | 36 | 100% | +4 (新規作成) |
| **成功テストスイート** | 5 | 13.9% | -2 (-8.0%) |
| **失敗テストスイート** | 31 | 86.1% | +6 (+8.0%) |
| **総テスト数** | 105 | 100% | -96 (モック問題により未実行) |
| **成功テスト数** | 82 | 78.1% | -27 (-23.9%) |
| **失敗テスト数** | 23 | 21.9% | -69 (+23.9%) |
| **実行時間** | 18.031秒 | - | -4.413秒短縮 |
