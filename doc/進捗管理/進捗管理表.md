...
| | **心拍数データ対応追加** | TBD | 2025-07-22 | 2025-07-22 | 未着手 | 0% | 1 | NotificationService修正 | SQLite, HealthKit | 中 | VitalDataService.ts, DatabaseService.ts - 心拍数データ種別追加、1日集計処理、最小値・最大値管理 |
| | **血圧データ拡張** | TBD | 2025-07-22 | 2025-07-22 | 未着手 | 0% | 0.5 | 心拍数データ対応 | React Native UI | 低 | VitalInputDialog.tsx, NewVitalInputDialog.tsx - 脈拍項目追加、心拍数と別表示 |
