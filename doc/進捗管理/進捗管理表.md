...
| タスク | サブタスク | 担当者 | 開始予定日 | 完了予定日 | 状況 | 進捗率 | 工数(人日) | 依存関係 | 技術要素 | リスクレベル | 備考 |
|--------|------------|--------|------------|------------|------|--------|------------|----------|----------|------------|------|
| **🔴 最優先修正作業** | **通知設定画面修正** | TBD | 2025-07-19 | 2025-07-19 | 未着手 | 0% | 0.5 | プロトタイプ完了 | React Native UI | 低 | NotificationSettingsScreen.tsx - 4つの通知設定項目追加（新規お知らせ、未閲覧検診、パルスサーベイ、ストレスチェック） |
| | **NotificationService修正** | TBD | 2025-07-19 | 2025-07-19 | 未着手 | 0% | 0.5 | 通知設定画面 | TypeScript型定義 | 低 | NotificationService.ts - NotificationSettings型拡張、新設定項目保存・読み込み処理 |
