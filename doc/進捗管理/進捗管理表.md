...
| **API通信** |  |  |  |  |  |  |
| axios | ^1.7.2 | 未インストール | ❌ 未実装 | 高 | 2025-08-01 | API通信必須、現在モック実装 |
| **ヘルスデータ** |  |  |  |  |  |  |
| react-native-health | ^1.19.0 | 未インストール | ❌ 未実装 | 高 | 2025-08-01 | iOS HealthKit連携必須 |
| react-native-health-connect | ^1.3.0 | 未インストール | ❌ 未実装 | 高 | 2025-08-01 | Android Health Connect連携必須 |
| @react-native-sensors/pedometer | ^7.2.0 | 未インストール | ❌ 未実装 | 中 | 2025-08-15 | Android歩数計 |
| **通知・設定** |  |  |  |  |  |  |
| @react-native-firebase/app | ^19.2.2 | 未インストール | ❌ 未実装 | 高 | 2025-08-01 | Firebase Core必須 |
| @react-native-firebase/messaging | ^19.2.2 | 未インストール | ❌ 未実装 | 高 | 2025-08-01 | Push通知必須 |
| @react-native-firebase/remote-config | ^19.2.2 | 未インストール | ❌ 未実装 | 中 | 2025-08-15 | 動的設定変更 |
