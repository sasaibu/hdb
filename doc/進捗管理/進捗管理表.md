...
| タスク | サブタスク | 担当者 | 開始予定日 | 完了予定日 | 状況 | 進捗率 | 工数(人日) | 依存関係 | 技術要素 | リスクレベル | 備考 |
|--------|------------|--------|------------|------------|------|--------|------------|----------|----------|------------|------|
| **🔴 最優先修正作業** | **通知設定画面修正** | 完了 | 2025-07-18 | 2025-07-18 | 完了 | 100% | 0.5 | プロトタイプ完了 | React Native UI | 低 | NotificationSettingsScreen.tsx - 4つの通知設定項目追加（新規お知らせ、未閲覧検診、パルスサーベイ、ストレスチェック） ✅ |
| | **NotificationService修正** | 完了 | 2025-07-18 | 2025-07-18 | 完了 | 100% | 0.5 | 通知設定画面 | TypeScript型定義 | 低 | NotificationService.ts - NotificationSettings型拡張、新設定項目保存・読み込み処理 ✅ |
| | **心拍数データ対応追加** | 完了 | 2025-07-18 | 2025-07-18 | 完了 | 100% | 1 | NotificationService修正 | SQLite, HealthKit | 中 | VitalDataService.ts, DatabaseService.ts - 心拍数データ種別追加、1日集計処理、最小値・最大値管理 ✅ |
| | **バイタル一覧画面実装** | 完了 | 2025-07-18 | 2025-07-18 | 完了 | 100% | 1 | 心拍数データ対応 | React Native UI, FlatList | 中 | VitalListScreen.tsx - 5つのバイタル種別タブ切り替え、編集・削除機能、歩数詳細遷移、ハンバーガーメニュー修正（設定→バイタル一覧）、コンパクトタブデザイン、タブとデータ間の空白問題解決 ✅ |
